...
class RecordInventoryMovementUseCase(UseCase[InventoryMovementCommand, InventoryMovement]):
    """
...
class ListInventoryMovementsBySourceDocumentUseCase(UseCase[tuple[str, int], list[InventoryMovement]]):
    def __init__(self, uow: UnitOfWork) -> None:
        self.uow = uow
